...
In this pull request, I was able to implement and design the all the necessary functionality for viewing, editing and deleting people within our app. This included designing and building these elements into the user interface, creating and implementing the ViewModel, and adding all necessary functionality within the database, manager and model folders. As a result, this pull request made significant changes to how users interact with people and events within our application. These changes to the UI were also conscientious to the Principles of Universal Design, allowing for features such as an EventList specific to the events of a person being viewed, and a "Are You Sure You Want To Delete That Person" popup/ Lastly, various other memebers of our group were also involved in other features on this pull request, making it a significant source of teamwork in Phase 2.
